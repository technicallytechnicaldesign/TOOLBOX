...
(function () {
  ...
  var I = {
    ...
    section: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="4" y="5" width="16" height="14" rx="1"/><circle cx="12" cy="12" r="3.2"/><line x1="12" y1="2.5" x2="12" y2="21.5" stroke-dasharray="3 2.5"/></svg>',
    check:   '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="5" y="3" width="14" height="18" rx="1.5"/><path d="M8 8.5l1.6 1.6L12.5 7"/><path d="M8 15.5l1.6 1.6L12.5 14"/><line x1="14.5" y1="9" x2="16.5" y2="9"/><line x1="14.5" y1="16" x2="16.5" y2="16"/></svg>',
    kb:      '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 6.2c2.2-1.6 5.3-1.6 8 0v13c-2.7-1.6-5.8-1.6-8 0z"/><path d="M20 6.2c-2.2-1.6-5.3-1.6-8 0v13c2.7-1.6 5.8-1.6 8 0z"/></svg>',
    goblin:  '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M7 10c0-3 2.2-5 5-5s5 2 5 5v3.5c0 3-2.2 5-5 5s-5-2-5-5z"/><path d="M7 8.5L3 6.5l3.4 3.2"/><path d="M17 8.5L21 6.5l-3.4 3.2"/><circle cx="10" cy="11.5" r="1.2" fill="currentColor" stroke="none"/><circle cx="14" cy="11.5" r="1.2" fill="currentColor" stroke="none"/><path d="M10 15h4"/></svg>',
